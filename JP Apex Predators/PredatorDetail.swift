    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .trailing) {
                ...
                NavigationLink(destination: PredatorPhoto(predatorImage: predator.name.lowercased().filter { $0 != " " }))
                {
...
struct PredatorDetailPreviews: PreviewProvider {
    static var previews: some View {
        ...
        ], movieScenes: [movieScene1, movieScene2], link: "https://jurassicpark.fandom.com/wiki/Tyrannosaurus_rex")
